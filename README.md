# nomad-insitu-tem-denssolutions
...
```
pip install dist/nomad-insitu-tem-denssolutions-0.1.0
```
...
### License
Distributed under the terms of the `MIT`_ license, "nomad-insitu-tem-denssolutions" is free and open source software
